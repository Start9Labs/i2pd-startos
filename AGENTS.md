...
- **`addI2pTunnel` refuses `bitcoind`'s peer hosts on purpose.** Bitcoin reaches I2P over the SAM bridge with a destination it owns; a server tunnel there delivers plain TCP it reads as bridge-local IPv4 peers.
